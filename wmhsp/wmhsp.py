    ...
    for i in range(0 , len(T1_Files_Test)):
        if (t1 != ''):
            ...
            if (nlmf == 'Y'):
                ...
                str_main_modality = str_t1_proc
            if (nuf == 'Y'):
                new_command = '/usr/local/bin/nu_correct ' + path_Temp + str(ID_Test[i]) + '_T1_NLM.mnc '  + path_Temp + str(ID_Test[i]) + '_T1_N3.mnc -iter 200 -distance 50 -clobber'
        ...
        if (flair != ''):
            ...
            if (nlmf == 'Y'):
                ...
                str_main_modality = str_flair_proc
            if (nuf == 'Y'):
                new_command = '/usr/local/bin/nu_correct ' + path_Temp + str(ID_Test[i]) + '_FLAIR_NLM.mnc '  + path_Temp + str(ID_Test[i]) + '_FLAIR_N3.mnc  -iter 200 -distance 50 -clobber'
